...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-8">
            ...
            <form method="POST" action="{{ route('edit', ['log_id' => $log->id])}}" class="p-5"
                    ...
                    <div class="cont">
                        <div class="stars">
                            ...
                            <input class="star star-{{ $i }}" id="star-{{ $i }}"
                                type="radio" name="score_id" value="{{ $i }}" {{ old('score_id', $log->score_id) == $i ? 'checked' : '' }} />
                ...
                <div class="form-group">
                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        <img src="{{ asset('storage/' . $image->path) }}" alt="Image"
                            class="img-thumbnail m-2" style="max-width: 150px; max-height: 150px;">
                        @endforeach
                        @endif
                        @for ($i = count($log->images ?? []); $i < 5; $i++)
                        <input id="images{{ $i+1 }}" type="file"
